...
const UsersTable = () => {
    ...
    useEffect(() => {
        axios
            .get('http://localhost:3000/auth/showUsers')
            .then((response) => {
    ...
    const handleDeleteUser = () => {
        axios
        .delete(`http://localhost:5555/deleteuser/${id}`) // Use userId from parameter
        .then(() => {
                ...
                <div className='d-flex justify-content-center users-tab-wrapper'>
                    <table className='users-tab'>
                        ...
                        <tbody>
                            {userr.map((user) => (
                                <tr key={user.id} >
                                    <td onClick={() => handleRowClick(user.id)}><img className='prof-img-tab' src={user.profileImage} alt="Profile" /></td>
                                    ...
                                    <td>
                                        ...
                                        <button className='gestion-btn' onClick={() => handleDeleteUser(user.id)}>
